...
In the verbose mode, the node will log a lot more information. | `true`
...
NOTE: Log4j2 supports runtime reconfiguration, i.e. changes in the configuration file will be applied without the need to restart the application.
